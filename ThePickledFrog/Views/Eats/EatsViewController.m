...
//    NSString *bodyFont = [configurationValues objectForKey:@"BodyFont"];
    ...
    if ([food.description2 length] != 0){
        attributedDescription = [[NSAttributedString alloc] initWithString:food.description2 attributes: attributes];
    ...
    if ([food.description3 length] != 0){
        attributedDescription = [[NSAttributedString alloc] initWithString:food.description3 attributes: attributes];
    ...
    if ([food.gettingThere length] != 0){
        ...
        attributedDescription = [[NSAttributedString alloc] initWithString:food.gettingThere attributes: attributes];
    ...
    if ([food.closestStop length] != 0){
        ...
        NSString *cs = [food.closestStop stringByAppendingString:@" "];
