...
//    segmentedControl.tintColor = [UIColor blackColor];
    ...
    if ([food.phone length] > 0){
        ...
        NSString *test = [NSString stringWithFormat:@"%@ ", food.phone];
...
//        NSAttributedString *attributedPhone = [[NSAttributedString alloc] initWithString:food.phone attributes: attributes];
    ...
    if ([food.website length] > 0){
        ...
        NSString *test = [NSString stringWithFormat:@"%@ ", food.website];
...
-(IBAction)callPhone {
    ...
    NSString *phoneNumber = [@"tel:" stringByAppendingString:food.phone];
